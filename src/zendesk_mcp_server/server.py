...
def build_tools() -> list[types.Tool]:
    return [
        ...
        types.Tool(name="zendesk_upsert_article_translation", description="Preview or upsert a draft article translation. Existing bodies require the separate replacement tool.", inputSchema={"type": "object", "properties": {"article_id": {"type": "integer", "minimum": 1}, "brand_id": {"type": "integer", "minimum": 1}, "locale": {"type": "string", "minLength": 2}, "title": {"type": "string", "minLength": 1}, "body": {"type": "string"}, "draft": {"const": True, "default": True}, "execution_mode": {"type": "string", "enum": ["preview", "apply"], "default": "preview"}, "approval_request_id": {"type": "string"}, "approval_token": {"type": "string"}}, "required": ["article_id", "locale"]}),
        types.Tool(name="zendesk_replace_article_translation_body", description="Preview or replace an existing article translation body. Apply requires destructive approval and may also require public-write approval.", inputSchema={"type": "object", "properties": {"article_id": {"type": "integer", "minimum": 1}, "brand_id": {"type": "integer", "minimum": 1}, "locale": {"type": "string", "minLength": 2}, "body": {"type": "string"}, "execution_mode": {"type": "string", "enum": ["preview", "apply"], "default": "preview"}, "approval_request_id": {"type": "string"}, "approval_token": {"type": "string"}}, "required": ["article_id", "locale", "body"]}),
        types.Tool(name="zendesk_publish_help_center_article", description="Preview or publish one draft Help Center article translation. Apply requires public-write approval and reads the translation back.", inputSchema={"type": "object", "properties": {"article_id": {"type": "integer", "minimum": 1}, "brand_id": {"type": "integer", "minimum": 1}, "locale": {"type": "string", "minLength": 2}, "execution_mode": {"type": "string", "enum": ["preview", "apply"], "default": "preview"}, "approval_request_id": {"type": "string"}, "approval_token": {"type": "string"}}, "required": ["article_id", "locale"]}),
