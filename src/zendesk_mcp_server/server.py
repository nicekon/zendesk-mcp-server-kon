...
def create_server(environ: Mapping[str, str] | None = None) -> Server:
    ...
    async def handle_call_tool(
        ...
        if name == "zendesk_get_connection_status":
        ...
        elif name in {"zendesk_list_help_center_locales", "zendesk_list_help_center_categories", "zendesk_list_help_center_sections", "zendesk_search_help_center_articles", "zendesk_export_help_center_articles", "zendesk_get_help_center_article", "zendesk_get_satisfaction_ratings", "zendesk_list_csat", "zendesk_list_guide_permission_groups", "zendesk_list_guide_user_segments", "zendesk_create_help_center_article", "zendesk_upsert_article_translation", "zendesk_replace_article_translation_body", "zendesk_publish_help_center_article"}:
            ...
            if isinstance(tools, dict):
                ...
                values = arguments or {}; result = tools.export_tickets(values.get("query"), cursor=values.get("cursor"), limit=values.get("limit", 100))
