...
def build_tools() -> list[types.Tool]:
    return [
        ...
        types.Tool(name="zendesk_create_help_center_article", description="Preview or create a draft Help Center article. Apply requires standard write mode and local approval; notifications additionally need the public-write gate.", inputSchema={"type": "object", "properties": {"section_id": {"type": "integer", "minimum": 1}, "brand_id": {"type": "integer", "minimum": 1}, "locale": {"type": "string", "minLength": 2}, "title": {"type": "string", "minLength": 1}, "body": {"type": "string"}, "labels": {"type": "array", "items": {"type": "string"}}, "position": {"type": "integer", "minimum": 0}, "permission_group_id": {"type": "integer", "minimum": 1}, "user_segment_id": {"type": "integer", "minimum": 1}, "draft": {"const": True, "default": True}, "notify_subscribers": {"type": "boolean", "default": False}, "execution_mode": {"type": "string", "enum": ["preview", "apply"], "default": "preview"}, "approval_request_id": {"type": "string"}, "approval_token": {"type": "string"}}, "required": ["section_id", "locale", "title", "body"]}),
        types.Tool(name="zendesk_upsert_article_translation", description="Preview or upsert a draft article translation. Existing bodies require the separate replacement tool.", inputSchema={"type": "object", "properties": {"article_id": {"type": "integer", "minimum": 1}, "locale": {"type": "string", "minLength": 2}, "title": {"type": "string", "minLength": 1}, "body": {"type": "string"}, "draft": {"const": True, "default": True}, "execution_mode": {"type": "string", "enum": ["preview", "apply"], "default": "preview"}, "approval_request_id": {"type": "string"}, "approval_token": {"type": "string"}}, "required": ["article_id", "locale"]}),
        types.Tool(name="zendesk_replace_article_translation_body", description="Preview or replace an existing article translation body. Apply requires destructive approval and may also require public-write approval.", inputSchema={"type": "object", "properties": {"article_id": {"type": "integer", "minimum": 1}, "locale": {"type": "string", "minLength": 2}, "body": {"type": "string"}, "execution_mode": {"type": "string", "enum": ["preview", "apply"], "default": "preview"}, "approval_request_id": {"type": "string"}, "approval_token": {"type": "string"}}, "required": ["article_id", "locale", "body"]}),
        types.Tool(name="zendesk_publish_help_center_article", description="Preview or publish one draft Help Center article translation. Apply requires public-write approval and reads the translation back.", inputSchema={"type": "object", "properties": {"article_id": {"type": "integer", "minimum": 1}, "locale": {"type": "string", "minLength": 2}, "execution_mode": {"type": "string", "enum": ["preview", "apply"], "default": "preview"}, "approval_request_id": {"type": "string"}, "approval_token": {"type": "string"}}, "required": ["article_id", "locale"]}),
        types.Tool(name="zendesk_list_community_posts", description="List Community posts with cursor pagination without making changes.", inputSchema={"type": "object", "properties": {"topic_id": {"type": "integer", "minimum": 1}, "user_id": {"oneOf": [{"type": "integer", "minimum": 1}, {"type": "string", "enum": ["me"]}]}, "status": {"type": "string", "enum": ["planned", "not_planned", "completed", "answered", "none"]}, "sort_by": {"type": "string", "enum": ["created_at", "edited_at", "updated_at", "recent_activity", "votes", "comments"]}, "cursor": {"type": "string", "minLength": 1}, "limit": {"type": "integer", "minimum": 1, "maximum": 100, "default": 100}}}),
        ...
        types.Tool(name="zendesk_list_community_votes", description="List Community votes for one post or user with safe cursor pagination; user results include posts and post comments only.", inputSchema={"type": "object", "properties": {"post_id": {"type": "integer", "minimum": 1}, "user_id": {"oneOf": [{"type": "integer", "minimum": 1}, {"type": "string", "enum": ["me"]}]}, "cursor": {"type": "string", "minLength": 1}, "limit": {"type": "integer", "minimum": 1, "maximum": 100, "default": 100}}, "anyOf": [{"required": ["post_id"]}, {"required": ["user_id"]}]}),
        ...
        types.Tool(name="zendesk_list_community_comments", description="List comments for one Community post or user with cursor pagination without making changes.", inputSchema={"type": "object", "properties": {"post_id": {"type": "integer", "minimum": 1}, "user_id": {"oneOf": [{"type": "integer", "minimum": 1}, {"type": "string", "enum": ["me"]}]}, "cursor": {"type": "string", "minLength": 1}, "limit": {"type": "integer", "minimum": 1, "maximum": 100, "default": 100}}}),
        ...
        types.Tool(name="zendesk_list_user_subscriptions", description="List Community user subscriptions with cursor pagination without making changes.", inputSchema={"type": "object", "properties": {"user_id": {"oneOf": [{"type": "integer", "minimum": 1}, {"type": "string", "enum": ["me"]}]}, "direction": {"type": "string", "enum": ["followers", "followings"], "default": "followers"}, "cursor": {"type": "string", "minLength": 1}, "limit": {"type": "integer", "minimum": 1, "maximum": 100, "default": 100}}, "required": ["user_id"]}),
    ...
    async def handle_call_tool(
        ...
        if name == "zendesk_get_connection_status":
            ...
            if isinstance(tools, dict): result = tools
                ...
                values = arguments or {}; result = tools.search_articles(values.get("query"), brand_id=values.get("brand_id"), locale=values.get("locale"))
                ...
                values = arguments or {}; result = tools.upsert_article_translation(values.get("article_id"), values.get("locale"), title=values.get("title"), body=values.get("body"), draft=values.get("draft", True), execution_mode=values.get("execution_mode", "preview"), approval_request_id=values.get("approval_request_id"), approval_token=values.get("approval_token"))
            elif name == "zendesk_replace_article_translation_body":
                values = arguments or {}; result = tools.replace_article_translation_body(values.get("article_id"), values.get("locale"), values.get("body"), execution_mode=values.get("execution_mode", "preview"), approval_request_id=values.get("approval_request_id"), approval_token=values.get("approval_token"))
            elif name == "zendesk_publish_help_center_article":
                values = arguments or {}; result = tools.publish_article(values.get("article_id"), values.get("locale"), execution_mode=values.get("execution_mode", "preview"), approval_request_id=values.get("approval_request_id"), approval_token=values.get("approval_token"))
